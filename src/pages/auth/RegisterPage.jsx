  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      if (formData.userType === 'mentee') {
        // For mentees, redirect to login page
        navigate('/login', { 
          state: { 
        ...
        // For mentors, continue to onboarding
    ...
    <div className="min-h-screen bg-gradient-to-br from-blue-50 via-white to-purple-50 flex items-center justify-center p-4">
      <div className="max-w-md w-full">
        ...
        <div className="text-center mb-8">
          ...
          <p className="text-gray-600">Join our mentorship community today</p>
        </div>
        ...
        <div className="bg-white rounded-2xl shadow-xl p-8 border border-gray-100">
          ...
          <div className="mb-6">
            ...
            <div className="grid grid-cols-2 gap-3">
              <button
                type="button"
                onClick={() => handleInputChange({ target: { name: 'userType', value: 'mentee' }})}
              ...
              <button
                type="button"
                onClick={() => handleInputChange({ target: { name: 'userType', value: 'mentor' }})}
                className={`p-4 border rounded-lg text-center transition-colors ${
              ...
              >
                ...
                <div className="text-xs text-gray-600 mt-1">Share expertise</div>
              </button>
            </div>
          </div>
          ...
          <div className="space-y-6">
            ...
            <div>
              <div className="flex items-start">
                ...
                <label htmlFor="agreeToTerms" className="ml-3 text-sm text-gray-700">
                  ...
                  <button
                    type="button"
                    onClick={() => alert('Terms of Service - integrate with your modal/page')}
                  ...
                  <button
                    type="button"
                    onClick={() => alert('Privacy Policy - integrate with your modal/page')}
                    className="text-blue-600 hover:text-blue-500 font-medium"
                  >
                    Privacy Policy
                  </button>
            ...
            >
              {isLoading ? (
                ...
                `Create ${formData.userType === 'mentee' ? 'Mentee' : 'Mentor'} Account`
              )}
            </button>
          </div>
